...
% TODO: this statement is non-trivial surely worth more than one point
...
\begin{figure}[htb]
  ...
  \begin{tikzpicture}[scale=1.5]
    \draw (4.2,0) -- (0,0) -- (0,3) -- (1,3) -- (1,0.5) -- (1.5,0.5) -- (1.5,3)
      -- (2.5,3) -- (2.5,0.5) -- (3,0.5) -- (3,3) -- (4,3) -- (4,0.5) -- (4.2,0.5);
    \foreach \y in {0, 0.5}
    {
      \draw [dashed] (4.2, \y) -- (4.8, \y);
    }
    \draw (4.8, 0.5) -- (5,0.5) -- (5,3) -- (6,3) -- (6,0) -- (4.8,0);
    \foreach \x in {1,2,3}
    {
      \node at (1.5*\x-1, 3.2) {$\x$};
    }
    \node at (5.5,3.2) {$n$};
  \end{tikzpicture}
...
\section*{Exercise 4 (Monotone Polygons) {\large \hfill (1 points)}}

The claim is false. Consider the triangulation of the monotone polygon in
Figure~\ref{fig:simpleNotChain}. The dual graph has nodes of degree 3 and is thus not a
\enquote{chain}. (Also see Exercise~5 for a similar monotone polygon whose triangulation
has a non-chain dual graph.)

\begin{figure}[htb]
  \centering
  \begin{tikzpicture}[scale=3]
    \draw [thick] (0,0) -- (1,0) -- (1,1) -- (2,1) -- (1,2) -- (1.5,2) -- (0.5,3)
      -- (-0.5,2) -- (0,2) -- (-1,1) -- (0,1) -- (0,0);
    \draw[dashed] (0,2) -- (0.5,3) -- (1,2) -- (0,2) -- (0,1) -- (1,2)
      -- (1,1) -- (0,0);
    \draw[dashed] (0,1) -- (1,1);
    \draw[red,thick] (0.5,2.28) --
      (1.13, 2.2)  node[circle,draw=red,fill=white] {};
    \draw[red,thick] (0.25,1.75) --
      (-0.25, 1.25)node[circle,draw=red,fill=white] {};
    \draw[red,thick] (0.75,1.25) --
      (1.25, 1.25) node[circle,draw=red,fill=white] {};
    \draw[red,thick]
      (0.75,0.25)  node[circle,draw=red,fill=white] {} --
      (0.25, 0.75) node[circle,draw=red,fill=white] {} --
      (0.75,1.25)  node[circle,draw=red,fill=white] {} --
      (0.25, 1.75) node[circle,draw=red,fill=white] {} --
      (0.5, 2.28)  node[circle,draw=red,fill=white] {} --
      (-0.13, 2.2) node[circle,draw=red,fill=white] {};
  \end{tikzpicture}
  \caption{Counterexample to Exercise~4}
  \label{fig:simpleNotChain}
\end{figure}
